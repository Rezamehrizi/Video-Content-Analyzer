...
headers = {
    ...
    "authorization": "fdadb4bb044b40f58685660be655bcd9",
...
# if default_bool:
#     file = 'https://www.youtube.com/watch?v=C_teb93alL4'
# else:
#     file = st.text_input('Enter your YouTube video link', 'https://youtu.be/dccdadl90vs')

link = st.text_input('Enter your YouTube video link', 'https://www.youtube.com/watch?v=C_teb93alL4')
st.video(link)
